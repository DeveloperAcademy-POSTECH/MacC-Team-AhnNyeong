    ...
    var body: some View {
        NavigationStack {
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack {
                    NavigationLink(destination: SettingMainView(selectedUserType: $selectedUserType, userName: "오복지")) {
                        Button {
                    ...
                    NavigationLink(destination: SettingMainView(selectedUserType: $selectedUserType, userName: "이김생리")) {
                        Button {
